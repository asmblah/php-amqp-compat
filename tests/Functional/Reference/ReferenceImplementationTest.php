...
class ReferenceImplementationTest extends AbstractTestCase
{
    ...
    public static function referenceImplementationTestProvider(): Generator
    {
        ...
        $phptFiles = glob(
            $basePath . '/{amqpconnection_construct_*,amqpconnection_connect_login_failure,amqpconnection_getUsedChannels,amqpconnection_connection_getters,amqpdecimal}.phpt',
            GLOB_BRACE
        );
