...
class ReferenceImplementationTest extends AbstractTestCase
{
    public const UNSUPPORTED_TESTS = [
        ...
        'amqpexchange_delete_default_exchange.phpt',
        'amqpexchange_get_channel.phpt',
        'amqpexchange_invalid_type.phpt',
        ...
        'amqpexchange_publish_with_decimal_header.phpt',
        ...
        'amqpexchange_publish_with_timestamp_header.phpt',
        'amqpexchange_publish_xdeath.phpt',
        'amqpexchange_setArgument.phpt',
        'amqpexchange_set_flags.phpt',
        'amqpexchange_unbind_with_arguments.phpt',
        'amqpexchange_unbind_without_key_with_arguments.phpt',
